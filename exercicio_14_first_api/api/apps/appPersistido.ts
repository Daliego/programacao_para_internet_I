...
import { microblogPersistente } from '../microBlogs/microBlogPersistente';
...
app.get('/posts/:id/comments', (req: Request, res: Response) => {
  ...
  try {
    microblogPersistente.retrievePrisma(postId)
    const comments = microblogPersistente.blogComment(postId)
    const postJson = JSON.stringify(comments)
